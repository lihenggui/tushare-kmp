...
internal class NewsApi(
     ...
     * @return 返回公告数据
     */
    override fun getAnnsD(params: AnnouncementParams): Flow<List<AnnouncementResult>> =
        flow {
     ...
     * @return 返回问答数据
     */
    override fun getIrmQaSh(params: IrmQaShParams): Flow<List<IrmQaShResult>> =
        flow {
            val apiParams = params.toApiParams()
     ...
     * @return 返回新闻快讯数据
     */
    override fun getNews(params: NewsParams): Flow<List<NewsResult>> =
        flow {
            val apiParams = params.toApiParams()
     ...
     * @return 返回新闻联播数据
     */
    override fun getCctvNews(params: CctvNewsParams): Flow<List<CctvNewsResult>> =
        flow {
            val apiParams = params.toApiParams()
     ...
     * @return 返回新闻通讯数据
     */
    override fun getMajorNews(params: MajorNewsParams): Flow<List<MajorNewsResult>> =
        flow {
            val apiParams = params.toApiParams()
     ...
     * @return 返回问答数据
     */
    override fun getIrmQaSz(params: IrmQaSzParams): Flow<List<IrmQaSzResult>> =
        flow {
            val apiParams = params.toApiParams()
