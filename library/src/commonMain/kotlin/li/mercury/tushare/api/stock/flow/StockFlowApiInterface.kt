...
interface StockFlowApiInterface {
     ...
     */
    fun getMoneyflowMktDc(params: MoneyflowMktDcParams): Flow<List<MoneyflowMktDcResult>>
     ...
     */
    fun getMoneyflowIndDc(params: MoneyflowIndDcParams): Flow<List<MoneyflowIndDcResult>>
     ...
     */
    fun getMoneyflowIndThs(params: MoneyflowIndThsParams): Flow<List<MoneyflowIndThsResult>>
     ...
     * @return 沪深港通资金流向数据流
     */
    fun getMoneyflowHsgt(params: MoneyflowHsgtParams): Flow<List<MoneyflowHsgtResult>>
}
