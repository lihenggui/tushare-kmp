...
public interface IndexApiInterface {
     ...
     */
    public fun getIndexBasic(params: IndexBasicParams): Flow<List<IndexBasicResult>>
     ...
     */
    public fun getIndexDaily(params: IndexDailyParams): Flow<List<IndexDailyResult>>
     ...
     */
    public fun getIndexWeekly(params: IndexWeeklyParams): Flow<List<IndexWeeklyResult>>
     ...
     */
    public fun getIndexMonthly(params: IndexMonthlyParams): Flow<List<IndexMonthlyResult>>
     ...
     */
    public fun getIndexWeight(params: IndexWeightParams): Flow<List<IndexWeightResult>>
     ...
     */
    public fun getIndexDailyBasic(params: IndexDailyBasicParams): Flow<List<IndexDailyBasicResult>>
     ...
     */
    public fun getIndexClassify(params: IndexClassifyParams): Flow<List<IndexClassifyResult>>
     ...
     */
    public fun getIndexMemberAll(params: IndexMemberAllParams): Flow<List<IndexMemberAllResult>>
     ...
     */
    public fun getSwDaily(params: SwDailyParams): Flow<List<SwDailyResult>>
     ...
     */
    public fun getDailyInfo(params: DailyInfoParams): Flow<List<DailyInfoResult>>
     ...
     */
    public fun getSzDailyInfo(params: SzDailyInfoParams): Flow<List<SzDailyInfoResult>>
     ...
     */
    public fun getThsDaily(params: ThsDailyParams): Flow<List<ThsDailyResult>>
     ...
     */
    public fun getCiDaily(params: CiDailyParams): Flow<List<CiDailyResult>>
     ...
     */
    public fun getIndexGlobal(params: IndexGlobalParams): Flow<List<IndexGlobalResult>>
     ...
     */
    public fun getIdxFactorPro(params: IdxFactorProParams): Flow<List<IdxFactorProResult>>
}
