...
import li.mercury.tushare.api.stock.StockRepository
import li.mercury.tushare.api.stock.StockRepositoryImpl
...
class TuShare(
    ...
    /** 访问股票相关API */
    val stock: StockRepository by lazy { StockRepositoryImpl(this) }
